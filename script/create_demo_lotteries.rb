...
if result1.success?
  ...
  topic1.first_post.revise(user, raw: description1, edit_reason: "Initial description")
...
if result2.success?
  ...
  topic2.first_post.revise(user, raw: description2, edit_reason: "Initial description")
...
if result3.success?
  ...
  topic3.first_post.revise(user, raw: description3, edit_reason: "Initial description")
...
if result4.success?
  ...
  topic4.first_post.revise(user, raw: description4, edit_reason: "Initial description")
