...
if old_test_topics.any?
  ...
  old_test_topics.each { |topic| topic.trash!(User.admins.first) }
...
draft_result =
  VzekcVerlosung::CreateLottery.call(
    params: {
      ...
      packets: [{ title: "Draft Packet 1" }, { title: "Draft Packet 2" }],
    },
    user: draft_user,
...
ended_result =
  VzekcVerlosung::CreateLottery.call(
    params: {
      ...
      duration_days: 7,
      category_id: category.id,
      packets: [{ title: "Ended Packet A" }, { title: "Ended Packet B" }],
    },
    user: ended_user,
...
tomorrow_result =
  VzekcVerlosung::CreateLottery.call(
    params: {
      ...
      duration_days: 7,
      category_id: category.id,
      packets: [{ title: "Tomorrow Packet 1" }, { title: "Tomorrow Packet 2" }],
    },
    user: tomorrow_user,
...
uncollected_result =
  VzekcVerlosung::CreateLottery.call(
    params: {
      ...
      duration_days: 7,
      category_id: category.id,
      packets: [{ title: "Uncollected Packet" }],
    },
...
if uncollected_result.success?
  ...
  if packet_posts.any?
    ...
    VzekcVerlosung::LotteryTicket.create!(post_id: packet_post.id, user_id: winner_user.id)
...
erb_result =
  VzekcVerlosung::CreateLottery.call(
    params: {
      ...
      duration_days: 7,
      category_id: category.id,
      packets: [{ title: "Collected Packet" }],
    },
    user: erb_owner,
...
if erb_result.success?
  ...
  if packet_posts.any?
    ...
    VzekcVerlosung::LotteryTicket.create!(post_id: packet_post.id, user_id: erb_winner.id)
...
draft_pms =
  Topic
    .where(archetype: Archetype.private_message, user_id: system_user.id)
    .joins(:topic_allowed_users)
    .where(topic_allowed_users: { user_id: draft_user.id })
    .count
...
ended_pms =
  Topic
    .where(archetype: Archetype.private_message, user_id: system_user.id)
    .joins(:topic_allowed_users)
    .where(topic_allowed_users: { user_id: ended_user.id })
    .count
...
tomorrow_pms =
  Topic
    .where(archetype: Archetype.private_message, user_id: system_user.id)
    .joins(:topic_allowed_users)
    .where(topic_allowed_users: { user_id: tomorrow_user.id })
    .count
...
uncollected_pms =
  Topic
    .where(archetype: Archetype.private_message, user_id: system_user.id)
    .joins(:topic_allowed_users)
    .where(topic_allowed_users: { user_id: uncollected_user.id })
    .count
...
erb_pms =
  Topic
    .where(archetype: Archetype.private_message, user_id: system_user.id)
    .joins(:topic_allowed_users)
    .where(topic_allowed_users: { user_id: erb_winner.id })
    .count
