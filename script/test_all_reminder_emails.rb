...
puts "  Uncollected reminders enabled: #{SiteSetting.vzekc_verlosung_uncollected_reminder_enabled}"
puts "  Erhaltungsbericht reminders enabled: #{SiteSetting.vzekc_verlosung_erhaltungsbericht_reminder_enabled}"
