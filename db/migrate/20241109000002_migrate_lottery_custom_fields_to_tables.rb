...
class MigrateLotteryCustomFieldsToTables < ActiveRecord::Migration[7.0]
  def up
    ...
    lottery_topic_ids.each do |topic_id|
      ...
      # Insert lottery record without display_id (will be backfilled in next migration)
      ...
      packet_post_ids.each do |post_id|
        ...
        # Insert packet record (ordinal and erhaltungsbericht_required will be added in later migrations)
        DB.exec(
          <<~SQL,
