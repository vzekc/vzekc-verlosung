...
export default apiInitializer((api) => {
  ...
  api.serializeToDraft("erhaltungsbericht_donation_id", "vzekc_erhaltungsbericht_donation_id");
  ...
  api.serializeOnCreate("erhaltungsbericht_donation_id", "vzekc_erhaltungsbericht_donation_id");
});
